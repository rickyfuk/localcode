...
// code below here
function additionByRestOperator(...arr) {
	return arr.reduce((a, b) => a + b, 0);
}

console.log(additionByRestOperator(4, 5, 6, 7));
// how to use rest operator for an real array??
const testarray = [2, 3, 5, 6, 7];
console.log(testarray.reduce((a, b) => a + b, 0));
// const testArrayBreak = testarray.map((num) =>
// 	console.log(additionByRestOperator(num))
// );
